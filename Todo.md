...
Set required environment variables (PowerShell example):
$env:API_HOST="0.0.0.0"
$env:API_PORT="8000"
$env:DEBUG="false"
$env:MODEL_PROVIDER="cerebras"
$env:MODEL_ID="llama-3.1-8b"
$env:API_KEY="YOUR_KEY"

cd D:\0_code\Smart_Glasses_Distilled

# Optional: (re)generate the long Markdown chapters

python docs\16_submission_package\build\generate_expanded_docs.py

# Optional: docx tooling (used after Pandoc)

pip install -r docs\16_submission_package\build\requirements-docx.txt

# Run export (Pandoc → .docx / .pptx → LibreOffice → .pdf)
