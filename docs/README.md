# Smart Glasses Distilled Documentation Hub

This folder contains all technical and product documentation for the project.
...
1. Overview: [01_overview/system_overview.md](01_overview/system_overview.md)
2. Architecture: [02_architecture/architecture.md](02_architecture/architecture.md)
3. Codebase map: [03_codebase/module_map.md](03_codebase/module_map.md)
4. Feature flows: [04_features/feature_flows.md](04_features/feature_flows.md)
5. AI system: [05_ai_system/ai_system.md](05_ai_system/ai_system.md)
6. Hardware integration: [06_hardware/hardware_integration.md](06_hardware/hardware_integration.md)
7. API reference: [07_api/api_reference.md](07_api/api_reference.md)
8. Data and state: [08_data/data_and_state.md](08_data/data_and_state.md)
9. Development guide: [09_dev_guide/development_guide.md](09_dev_guide/development_guide.md)
10.   Operations: [10_operations/operations_runbook.md](10_operations/operations_runbook.md)
11.   Security notes: [11_security/security_notes.md](11_security/security_notes.md)
